...
////// Emissive:
                ...
                float node_6709 = 1.0;
                float node_2846 = (node_6709/_ScreenParams.r);
                float node_2631 = (_BlurSampleDistance+(saturate((sceneZ-partZ)/_MaxDistance)*_BlurDistanceScalar));
                float2 node_3334 = float2((node_2846*node_2631),((node_6709/_ScreenParams.g)*node_2631));
